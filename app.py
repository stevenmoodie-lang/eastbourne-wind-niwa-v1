...
def get_front_lead_live():
    try:
        ...
        # Using standard html.parser for better compatibility
        ...
        for row in table.find_all('tr'):
            ...
            # Search for "Front Lead" anywhere in the first cell
            location_text = cells[0].text.strip().lower()
            if "front" in location_text and "lead" in location_text:
